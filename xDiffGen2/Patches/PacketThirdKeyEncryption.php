<?php
		...
		function PacketThirdKeyEncryption($exe) {
			if ($exe === true) {
				return new xPatch(94, 'Packet Second Key Encryption', '', 0, 'Change the 3rd key for packet encryption. It needs you don\'t check the patch Disable Packet Header Encryption. Don\'t use it if you don\'t know what you are doing. (Not avaible yet on rathena)
